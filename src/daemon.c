...
#define PUSH_CHAR(ch)                    \
        ...
        case '(':
          ...
          break;
#define CO(c,x) case c:PUSH_CHAR(#x);break;
#define CD(c,x,y) case c:PUSH_CHAR(#x);PUSH_CHAR(#y);break;
#define CT(c,x,y,z) case c:PUSH_CHAR(#x);PUSH_CHAR(#y);PUSH_CHAR(#z);break;
#define CP(c,x,y,z,w) case c:PUSH_CHAR(#x);PUSH_CHAR(#y);PUSH_CHAR(#z);PUSH_CHAR(#w);break;
        case '.':
          switch (buf[4]) {
            CO('a',α)
            CO('b',β)
